...
GROUP BY 
    usuario, 
    Descripcion, 
    CASE WHEN dol IS NULL THEN SIGLA ELSE dol END, 
    ID_Docente, 
    Docente
ORDER BY usuario, Descripcion
;
